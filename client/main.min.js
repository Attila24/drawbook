...
CommentService;CommentService.$inject = ['$http', 'server']; /* @ngInject */function CommentService($http, server) {
    return {
        ...
        get: function get(user, imageid) {return $http.get(server.url + '/users/' + user.username + '/images/' + imageid).then(function (res) {return res.data;});},
...
LikeService;LikeService.$inject = ['$q', '$http', 'server']; /* @ngInject */function LikeService($q, $http, server) {
    return {
        ...
        get: function get(username, id) {return $http.get(server.url + '/users/' + username + '/images/' + id + '/likes/').then(function (res) {return res.data;});},
...
UserImageController;UserImageController.$inject = ['$stateParams', 'ImageService', 'user', '$state', '$scope', 'CommentService', 'localStorageService', 'LikeService', '$q']; /* @ngInject */function UserImageController($stateParams, ImageService, user, $state, $scope, CommentService, localStorageService, LikeService, $q) {
    ...
    function init() {
        vm.isLiked = false;
        vm.currentUser = localStorageService.get('currentUser');
        loadLikes().then(function (res) {vm.isLiked = res;});
